...
public class Line_7 extends Point_7 { // point 패키지의 Point_6클래스를 상속받은 Line_6클래스 정의
    ...
    public int get_x() { // x값 반환 // super.public method로 접근한 모습입니다.
        if (super.get_x() > 0){
            return super.get_x(); // super.public method로 접근한 모습입니다.
        } else {
            return 0;
        }
    }

    public int get_y() { // y값 반환 // super.public method로 접근한 모습입니다.
        if (super.get_y() > 0){
            return super.get_y(); // super.public method로 접근한 모습입니다.
        } else {
            return 0;
        }
    }
