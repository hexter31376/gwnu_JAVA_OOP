...
public class Line_3 extends point.Point_3 { // point 패키지의 Point_1클래스를 상속받은 Line_1클래스 정의
    int a, b;

    public Line_3(int x, int y, int a, int b){ // 부모 클래스 필드 x와 y, 자식 클래스(지금 이 클래스) 필드 a, b 입력받을때의 객체 생성자 Point_4 정의
